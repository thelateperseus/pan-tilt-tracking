...
def obj_center(objX, objY, centerX, centerY):
    ...
    vs = VideoStream(usePiCamera=True, vflip=True, hflip=True).start()
    time.sleep(2.0)

    # initialize the object center finder
    obj = ObjCenter(cv2.data.haarcascades + "haarcascade_frontalface_default.xml")
